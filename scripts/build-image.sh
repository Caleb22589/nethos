...
#                    Add "firmware" for real hardware, "browser" for Chromium.
set -euo pipefail
...
GRUB_CMDLINE_LINUX_DEFAULT="quiet loglevel=3 systemd.show_status=false vt.global_cursor_default=0 console=tty0 console=ttyAMA0,115200"
GRUB_CMDLINE_LINUX=""
